    ...
    if ($result) {
        ...
        if ($no_rekam_medis === $nik) {
            ...
            if ($result) {
                ...
                untuk mendaftar sebagai pasien baru di puskesmasalianyangpnk.site 
                <br><br><br>
                ...
                sendMailAdmin($email, $nama, $title, $content);
...
if (isset($_POST['edit_data_nik_rekmed'])) {
    ...
    if ($status_pasien !== $status_pasien_prev) {
        ...
        if ($data['total_anggota'] > 1) {
            ...
            $_SESSION['error_msg'] = "Status pasien tidak dapat diubah karena jumlah anggota keluarga pasien";
