                        ...
                        <tr>
                            ...
                            <td>
                                <div class="col-lg-8 col-12">
                                    <input type="text" class="form-control form-control-sm" name="username" id="username" maxlength="50" required autocomplete='off'>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <div class="col-lg-8 col-12">
                                    ...
                                    if (isset($_SESSION['nama_depan'])) {
                                        ...
                                        echo "<input type='text' class='form-control form-control-sm' name='nama_depan' id='namaDepan' maxlength='30' required autocomplete='off'>";
                                    }
                                    ?>
                                </div>
                            </td>
                            ...
                            <td>
                                <div class="col-lg-8 col-12">
                                    ...
                                    if (isset($_SESSION['nama_belakang'])) {
                                        ...
                                        echo "<input type='text' class='form-control form-control-sm' name='nama_belakang' id='namaBelakang' maxlength='30' autocomplete='off'>";
                                    }
                                    ?>
                                </div>
                            </td>
