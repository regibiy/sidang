        ...
        <div class="bg-blue position-fixed z-3" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                if ($_SESSION['role'] == "daftar") {
                    if ($currentPath == "/admin/index-registration.php" || $currentPath == "/admin/index-registration-rancang.php") {
                        echo '
                        ...
                        ';
                    } elseif ($currentPath == "/admin/all-registration.php") {
                        echo '
                            ...
                            <a href="report-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">summarize</span>Laporan</a>
                        ';
                    } elseif ($currentPath == "/admin/patient-registration.php" || $currentPath == "/admin/detail-patient-registration.php") {
                        echo '
                            <a href="index-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">health_metrics</span>Dashboard</a>
                            <a href="all-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">browse_activity</span>Pendaftaran</a>
                            ...
                            <a href="report-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">summarize</span>Laporan</a>
                        ';
                    } elseif ($currentPath == "/admin/activity-registration.php" || $currentPath == "/admin/add-activity-registration.php" || $currentPath == "/admin/edit-activity-registration.php" || $currentPath == "/admin/edit-doctor-registration.php") {
                        echo '
                            <a href="index-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">health_metrics</span>Dashboard</a>
                            <a href="all-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">browse_activity</span>Pendaftaran</a>
                            <a href="patient-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">patient_list</span>Pasien</a>
                            ...
                            <a href="report-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">summarize</span>Laporan</a>
                        ';
                    } elseif ($currentPath == "/admin/report-registration.php") {
                        echo '
                            <a href="index-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">health_metrics</span>Dashboard</a>
                            <a href="all-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">browse_activity</span>Pendaftaran</a>
                            <a href="patient-registration.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">patient_list</span>Pasien</a>
                    ...
                    if ($currentPath == "/admin/index-medical-record.php") {
                        echo '
                    ...
                    } elseif ($currentPath == "/admin/all-registration-medical-record.php") {
                        echo '
                        ...
                        echo '<a href="report-medical-record.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">summarize</span>Laporan</a>';
                    } elseif ($currentPath == "/admin/patient-medical-record.php" || $currentPath == "/admin/detail-patient-medical-record.php" || $currentPath == "/admin/edit-patient-medical-record.php") {
                        echo '
                            <a href="index-medical-record.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">health_metrics</span>Dashboard</a>
                            <a href="all-registration-medical-record.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">browse_activity</span>Pendaftaran</a>';
                        ...
                        echo '<a href="report-medical-record.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">summarize</span>Laporan</a>';
                    } elseif ($currentPath == "/admin/report-medical-record.php") {
                        echo '
                            <a href="index-medical-record.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">health_metrics</span>Dashboard</a>
                            <a href="all-registration-medical-record.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">browse_activity</span>Pendaftaran</a>';
                        if (isset($notif)) echo '<a href="patient-medical-record.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">patient_list</span>Pasien <span class="ms-2 bg-danger px-2 rounded text-white">' . $notif . '</span></a>';
                    ...
                    if ($currentPath == "/admin/index-head.php") {
                        echo '
                            ...
                            ';
                    } elseif ($currentPath == "/admin/officer.php" || $currentPath == "/admin/add-officer.php" || $currentPath == "/admin/edit-officer.php") {
                        echo '
                        ...
                        <a href="poly-room-head.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">home_health</span>Ruang Poli</a>
                        ';
                    } elseif ($currentPath == "/admin/poly-room-head.php" || $currentPath == "/admin/add-poly-room-head.php" || $currentPath == "/admin/edit-poly-room-head.php") {
                        echo '
                        <a href="index-head.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">health_metrics</span>Dashboard</a>
                        <a href="officer.php" class="list-group-item my-list-group-item-action bg-transparent second-text"><span class="material-symbols-sharp me-2">admin_panel_settings</span>Petugas</a>
