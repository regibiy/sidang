                            ...
                            <td>
                                <div class="col-lg-8 col-12">
                                    ...
                                    if (isset($_SESSION['nama_ruang'])) {
                                        echo "<input type='text' class='form-control form-control-sm' name='nama' id='nama' value='" . $_SESSION['nama_ruang'] . "' required autocomplete='off'>";
                                        unset($_SESSION['nama_ruang']);
                                    } else echo "<input type='text' class='form-control form-control-sm' name='nama' id='nama' placeholder='Ruang Pemeriksaan Umum' required autocomplete='off'>"
                                    ?>
                                </div>
                            </td>
                        </tr>
