...
<div class="container">
    <div class="d-flex justify-content-center align-items-center flex-column gap-3 min-vh-100">
        ...
        <?php
        if (isset($_SESSION['role'])) echo "<a href='admin/index.php' class='text-decoration-none'>Kembali ke halaman utama</a>";
        else echo "<a href='index.php' class='text-decoration-none'>Kembali ke halaman utama</a>";
        ?>
    </div>
</div>
