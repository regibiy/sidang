        ...
        <div class="d-flex justify-content-between col-12 flex-wrap">
            <div class="d-flex flex-column align-items-start col-lg-3 col-12 gap-3 mb-4">
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p id="alertModal" class="bg-danger text-white fs-7 rounded py-1 px-2" style="display: none;"></p>
                ...
                <div class="accordion col-12" id="accordionPanelsStayOpenExample">
                    ...
                    //                     WHEN @status_hubungan != status_hubungan THEN 1
                    //                     ELSE @row_number + 1
                    //                 END AS rn,
                    //                 @status_hubungan:=status_hubungan AS status_hubungans,
                    //                 pasien.*
                    //             FROM pasien
                    //             CROSS JOIN (SELECT @row_number:=0, @status_hubungan:='') AS vars
                    //             WHERE no_kk = '$no_kk' AND status_pasien = 'Dalam KK'
                    //             ORDER BY status_hubungan
                    //         ) AS subquery
                    //     ) AS subquery2 ORDER BY rn";
